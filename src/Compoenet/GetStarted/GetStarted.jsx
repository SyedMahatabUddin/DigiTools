...
return (
  ...
  <div className="bg-[#F9FAFC] py-20 my-20 ">
     ...
     <div className="flex justify- mx-auto gap-5  max-w-300 items-center mt-4">

        <div className=" border-[#F6F6F6] bg-white flex flex-col items-center my-10 pt-4 pb-20 px-5  rounded-2xl border-2 space-y-4 hover:-translate-y-2 hover:scale-105 transition-transform ease-in-out duration-200">
          ...
          <div className="bg-linear-to-r from-[#4F39F6]/10  to-[#9514FA]/10 p-5 rounded-full w-fit">
             <img src="/src/assets/user.png " alt="" className="w-15 h-15 object-contain " />
          </div>
        ...
        <div className=" border-[#F6F6F6] bg-white flex flex-col items-center my-10 pt-4 pb-20 px-5  rounded-2xl border-2 space-y-4 hover:-translate-y-2 hover:scale-105 transition-transform ease-in-out duration-200">
          <p className="bg-linear-to-r  from-[#4F39F6] to-[#9514FA] rounded-full p-5 text-[14px] text-white w-10 h-10  flex justify-center items-center ml-auto  ">01</p>
          <div className="bg-linear-to-r from-[#4F39F6]/10  to-[#9514FA]/10 p-5 rounded-full w-fit">
             <img src="/src/assets/rocket.png " alt="" className="w-15 h-15 object-contain " />
          </div>
          <h4 className="text-[#101727] text-2xl font-bold ">Create Account</h4>
          <p className="text-[#627382] text-[16px] text-center ">Sign up for free in seconds. No credit card required to get started.</p>
        </div>
        ...
        <div className=" border-[#F6F6F6] bg-white flex flex-col items-center my-10 pt-4 pb-20 px-5  rounded-2xl border-2 space-y-4 hover:-translate-y-2 hover:scale-105 transition-transform ease-in-out duration-200">
          <p className="bg-linear-to-r  from-[#4F39F6] to-[#9514FA] rounded-full p-5 text-[14px] text-white w-10 h-10  flex justify-center items-center ml-auto  ">01</p>
          <div className="bg-linear-to-r from-[#4F39F6]/10  to-[#9514FA]/10 p-5 rounded-full w-fit">
             <img src="/src/assets/package.png " alt="" className="w-15 h-15 object-contain " />
          </div>
          <h4 className="text-[#101727] text-2xl font-bold ">Create Account</h4>
          <p className="text-[#627382] text-[16px] text-center ">Sign up for free in seconds. No credit card required to get started.</p>
        </div>
