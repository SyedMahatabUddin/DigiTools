...
return (
  <div className="bg-linear-to-r  from-[#4F39F6] to-[#9514FA] py-30 mt-20 text-center space-y-3">
     ...
     <div className='flex gap-4 py-6 justify-center'>
       <div class="rounded-full bg-white hover:bg-gray-100 hover:-translate-y-0.5 hover:scale-103 transition-transform ease-in-out duration-200">
             <button class=" items-center bg-linear-to-r from-[#4F39F6] to-[#9514FA] bg-clip-text text-transparent font-bold text-[16px] cursor-pointer py-2 px-5 ">Subscribe</button>
       </div>
