...
const Workflow = () => {
return (
  <div className="bg-linear-to-r  from-[#4F39F6] to-[#9514FA] py-10 px-4 sm:py-30 mt-20 text-center space-y-3">
     ...
     <div className='flex gap-2 sm:gap-4 py-6 justify-center'>
